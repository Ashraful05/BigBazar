...
@section('title','Edit Blog Post page')
    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                ...
                <form action="{{route('update-blog-post',['id'=>$editBlogPost->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="post_title_en"  value="{{ $editBlogPost->post_title_en }}" placeholder="Enter post title in english">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="post_title_in" value="{{ $editBlogPost->post_title_in }}" placeholder="Enter post title in hindi">
                                ...
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select class="form-control select2" name="category_id">
                                        ...
                                        @foreach($blogCategories as $blogCategory)
                                            ...
                                            <?php if($blogCategory->id == $editBlogPost->category_id){echo "selected";} ?>
                                            >{{$blogCategory->category_name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mg-b-10-force" >
                                    ...
                                    <textarea class="form-control" name="details_in" id="summernote1" cols="30" rows="10">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force" >
                                    ...
                                    <label class="custom-file">
                                        <img src="{{ url($editBlogPost->post_image) }}" style="height: 80px;width: 100px;" id="one" alt="">
