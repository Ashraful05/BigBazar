                        ...
                        <form action="{{route('payment-process')}}" method="post" id="contact_form">
                            ...
                            <div class="form-group">
                                <ul class="logos_list">
                                    ...
                                    <li><input type="radio" name="payment" value="ideal"><img src="{{ asset('public/frontend/images/mollie.png') }}" style="width: 100px;height: 60px;" alt=""></li>
                                    <li><input type="radio" name="payment" value="oncash"><img src="{{ asset('public/frontend/images/delivery.png') }}" style="width: 100px;height: 60px;" alt=""></li>

                                </ul>
                            </div>

                            <div class="contact_form_button text-center">
                                <button type="submit" name="btn" class="btn btn-info">Pay Now</button>
                            </div>
                        </form>
