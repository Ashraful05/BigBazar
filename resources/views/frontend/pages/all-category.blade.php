...
@section('content')
    ...
    <div class="home">
        ...
        <div class="home_content d-flex flex-column align-items-center justify-content-center">
            <h2 class="home_title">Category Wise Product</h2>
        </div>
    </div>
                        ...
                        <div class="sidebar_section">
                            ...
                            <ul class="sidebar_categories">
                                ...
                                @foreach($category as $row)
                                    <li><a href="{{ url('all-category/'.$row->id) }}">{{$row->category_name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                            ...
                            <!-- Product Item -->
                                <div class="product_item is_new">
                                    ...
                                    <div class="product_content">
                                        ...
                                        @endif
                                        <div class="product_name"><div><a href="{{ route('product.details',['id'=>$row->id,'product_name'=>$row->product_name]) }}" tabindex="0">{{$row->product_name}}</a></div></div>
                                    </div>
                                    <div class="product_fav"><i class="fas fa-heart"></i></div>
                                    <ul class="product_marks">
                                        @if($row->discount_price == Null)
                                            <li class="product_mark product_new" style="background-color: blue;">New</li>
                                        @else
