...
@section('content')
    ...
    @php
        ...
        $hot = DB::table('products')
                ...
                ->where('products.status',1)->where('hot_deal',1)->orderBy('id','desc')
                ->limit(4)
                ->get();
    ...
    <div class="container">
                                        ...
                                        <div class="owl-item deals_item">
                                            ...
                                            <div class="deals_content">
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    ...
                                                    @else
                                                        <div class="deals_item_price_a ml-auto">Tk.{{ $row->product_price }}</div>
                                                    @endif
                                                </div>
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_name">{{ $row->product_name }}</div>
                                                    @if ($row->discount_price == NULL)
                                                        <div class="deals_item_price_a ml-auto"><strong>Tk.{{ $row->product_price }}</strong></div>
                                                    @else

                                                    @endif

                                                    @if($row->discount_price != NULL)
                                                        <div class="deals_item_price ml-auto">Tk.{{ $row->discount_price }}</div>
                                                    @else
                                                    @endif
                                                </div>
                                                <div class="available">
                                        ...
                                        <!-- Slider Item -->
                                            <div class="featured_slider_item">
                                                ...
                                                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($row->image_one) }}" style="height:80px; width: 100px;" alt=""></div>
                                                    <div class="product_content">
                                                        @if($row->discount_price == Null)
                                                            <div class="product_price discount">TK. {{ $row->product_price }}</div>
                                                        @else
                                                            <div class="product_price discount">TK. {{ $row->discount_price }} <span>{{ $row->product_price }}</span>  </div>
                                                        @endif

                                                        <div class="product_name"><div><a href="{{ route('product.details',['id'=>$row->id,'product_name'=>$row->product_name]) }}">{{ $row->product_name }}</a></div></div>
                                                        {{--                                                        <div class="product_extras">--}}
                                                        {{--                                                            <button class="product_cart_button addcart" data-id="{{ $row->id }}">Add to Cart</button>--}}
                                                        {{--                                                        </div>--}}
                                                        <div class="product_extras">
                                                            <button class="product_cart_button addcart" id="{{$row->id}}" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)" >Add to Cart</button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="product_marks">
                                                        ...
                                                        @else
                                                            <li class="product_mark product_discount">
                                                                @php
                                                                    $amount = $row->product_price - $row->discount_price;
                                                                    $discount = ($amount / $row->product_price)*100;
                                                                @endphp
                                                                {{ intval($discount) }}%
                                                            </li>
                                                        @endif
                                    ...
                                    <div class="row fill_height">
                                        ...
                                        <div class="col-lg-8 col-md-6 fill_height">
                                            <div class="banner_2_image_container">
                                                <div class="banner_2_image"><img src="{{ asset($row->image_one) }}" style="height:200px; width: 250px;" alt=""></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        @php
            ...
            $product = DB::table('products')->where('category_id',$categoryId)->where('status',1)->limit(10)->orderBy('id','desc')->get();
        @endphp
                    ...
                    <div class="col">
                        <div class="tabbed_container">
                            <div class="tabs clearfix tabs-right">
                                <div class="new_arrivals_title">{{ $categories->category_name }}</div>
                                <ul class="clearfix">
                                    <li class="active"></li>
                                </ul>
                                <div class="tabs_line"><span></span></div>
                                        ...
                                        @foreach($product as $row)
                                            <!-- Slider Item -->
                                                <div class="featured_slider_item">
                                                    <div class="border_active"></div>
                                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($row->image_one) }}" style="height:100px; width: 140px;" alt=""></div>
                                                        <div class="product_content">
                                                            @if($row->discount_price == Null)
                                                                <div class="product_price discount">TK. {{ $row->product_price }}</div>
                                                            @else
                                    ...
                                    <div class="owl-item">
                                        <div class="trends_item is_new">
                                            ...
                                            <div class="trends_content">
                                                <div class="trends_category"><a href="#">{{ $row->product_name }}</a></div>
                                                <div class="trends_info clearfix">
                                                    <div class="trends_name"><a href="product.html">{{ $row->brand_name }}</a></div>
                                                    @if ($row->discount_price == NULL)
                                                        <div class="product_price discount">Tk.{{ $row->product_price }}</div>
                                                    @else
                                                        <div class="product_price discount">Tk.{{ $row->discount_price }} <span>TK. {{ $row->product_price }}</span> </div>
                                                    @endif
                                                    <a href="" class="btn btn-sm btn-danger">Add to Cart</a>
                                                </div>
                                            </div>
                                            <ul class="trends_marks">
                                                <li class="trends_mark trends_new">Buy&Get</li>
                                            </ul>
                                            <button class="addwishlist" data-id="{{ $row->id }}">
                    ...
                    <div class="col">
                        <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                            ...
                            <div class="newsletter_content clearfix">
                                <form action="{{route('save-newsletter')}}" method="post" class="newsletter_form">
                                    @csrf
    ...
    <!-- Modal -->
    <div class="modal fade" id="cartmodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <img src="" class="text-center" id="pimage" style="height: 200px; width: 200px;" alt="">
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Stock: <span class="badge" style="background-color: green;color: white;">Available</span></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <form action="{{ route('insert-into-cart') }}" method="post">
                                ...
                                <button type="submit" name="btn" class="btn btn-sm btn-primary">Add To Cart</button>
                            </form>
                        </div>
                        </div>
                    </div>
